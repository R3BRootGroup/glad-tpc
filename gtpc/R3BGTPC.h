...
class R3BGTPC : public R3BDetector {
 public:
   ...
   ** active volume. Creates a R3BGTPCPoint and adds it
   ** to the collection.
 ...
 private:
  ...
  TClonesArray* fGTPCCollection;           //!  The point collection

  /** Private method AddHit
   **
   ** Adds a GTPCPoint to the HitCollection
   **/
  R3BGTPCPoint* AddPoint(Int_t trackID,
			       Int_t detID,
			       Int_t volid,
			       Double_t Z,
			       Double_t A,
...
inline void R3BGTPC::ResetParameters()
{
