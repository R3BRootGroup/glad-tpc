...
void checkAll() {
  ...
  if(graphicalOutput && checkMCTracks){  //HISTOGRAMS DEFINITION FOR MCTRACKS
  ...
  if(graphicalOutput && checkPoints){  //HISTOGRAMS DEFINITION FOR POINTS
    ...
    h1_Point_TrackStatus = new TH1F("h1_Point_TrackStatus","Point TrackStatus",
				    8,0,7);
    ...
    h2_Point_XZ = new TH2F("h2_Point_XZ","Points proyection on XZ plane",
			   600,-30,30,1100,195,305);
    h2_Point_YZ = new TH2F("h2_Point_YZ","Point proyection on XY plane",
			   600,-30,30,1100,195,305);
    h2_Point_PxPz = new TH2F("h2_Point_PxPz","Momentum proyection on XZ plane",
			   600,-1,1,600,-1,7);
    h2_Point_PyPz = new TH2F("h2_Point_PyPz","Momentum proyection on XY plane",
			   600,-1,1,600,-1,7);
  }
  ...
  for(Int_t i=0;i<nevents;i++){
    ...
    if(textOutput){
      cout << endl <<"INFO:  The number of points in this event is "
	   << pointsPerEvent << endl;
      cout << "INFO:  The number of MCtracks in this event is "
	   << MCtracksPerEvent << endl;
    }
    ...
    if(checkPoints){
      if(graphicalOutput) h1_Point_Mult->Fill(pointsPerEvent);
    ...
    if(pointsPerEvent) delete[] point;
  ...
  if(graphicalOutput){
    ...
    c1->cd();
    c1->Divide(2,3);
    c1->cd(1); c1->cd(1)->SetLogy(); h1_MC_Mult->Draw();
    c1->cd(2); c1->cd(2)->SetLogy(); h1_MC_MultSec->Draw();
    c1->cd(3); c1->cd(3)->SetLogy(); h1_MC_PDGSec->SetLineColor(kRed);
    h1_MC_PDGSec->Draw(); h1_MC_PDG->Draw("SAME");
    TLatex Tl;
    Tl.SetTextSize(0.06); Tl.SetTextColor(1); Tl.DrawLatex(200, 10,"Primaries");
    Tl.SetTextSize(0.06); Tl.SetTextColor(2); Tl.DrawLatex(1400, 10,"Secondaries");
    c1->cd(4); c1->cd(4)->SetLogy(); h1_MC_EneSec->SetLineColor(kRed);
    h1_MC_EneSec->Draw(); h1_MC_Ene->Draw("SAME");
    Tl.SetTextSize(0.06); Tl.SetTextColor(1); Tl.DrawLatex(5*maxE, 10,"Primaries");
    Tl.SetTextSize(0.06); Tl.SetTextColor(2); Tl.DrawLatex(20*maxE, 10,"Secondaries");
    c1->cd(5); c1->cd(5)->SetLogy(); h1_MC_ThetaSec->SetLineColor(kRed);
    h1_MC_ThetaSec->Draw(); h1_MC_Theta->Draw("SAME");
    Tl.SetTextSize(0.06); Tl.SetTextColor(1); Tl.DrawLatex(0.2, 2,"Primaries");
    Tl.SetTextSize(0.06); Tl.SetTextColor(2); Tl.DrawLatex(1.8, 2,"Secondaries");
    c1->cd(6); c1->cd(6)->SetLogy(); h1_MC_PhiSec->SetLineColor(kRed);
    h1_MC_PhiSec->Draw(); h1_MC_Phi->Draw("SAME");
    Tl.SetTextSize(0.06); Tl.SetTextColor(1); Tl.DrawLatex(-2, 2,"Primaries");
    Tl.SetTextSize(0.06); Tl.SetTextColor(2); Tl.DrawLatex(0.8, 2,"Secondaries");

    //POINT CANVAS
    c2->cd();
    c2->Divide(3,3);
    c2->cd(1); c2->cd(1)->SetLogy(); h1_Point_Mult->Draw();
    c2->cd(2); c2->cd(2)->SetLogy();h1_Point_Time->Draw();
    c2->cd(3); c2->cd(3)->SetLogy();h1_Point_Length->Draw();
    c2->cd(4); c2->cd(4)->SetLogy();h1_Point_ELoss->Draw();
    c2->cd(5); c2->cd(5)->SetLogy();h1_Point_trackStep->Draw();
    c2->cd(6); c2->cd(6)->SetLogy();h1_Point_PDG->Draw();
    c2->cd(7); c2->cd(7)->SetLogy();h1_Point_Charge->Draw();
    c2->cd(8); c2->cd(8)->SetLogy();h1_Point_Mass->Draw();
    c2->cd(9); c2->cd(9)->SetLogy();h1_Point_Kine->Draw();
    ...
    c3->cd();
    c3->Divide(2,2);
    c3->cd(1); h2_Point_XZ->Draw();
    c3->cd(2); h2_Point_YZ->Draw();
    c3->cd(3); h2_Point_PxPz->Draw();
    c3->cd(4); h2_Point_PyPz->Draw();
