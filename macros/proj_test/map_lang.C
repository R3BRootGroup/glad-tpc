...
void map_lang() {
  ...
  for(Int_t gridPoint_z=0; gridPoint_z<39;gridPoint_z++){ //39 points from 5 to 195 cm (200cm long TPC)
    for(Int_t gridPoint_x=0; gridPoint_x<15;gridPoint_x++){ //15 points from 5 to 75 cm (80cm wide TPC)
      sprintf(tit,"hist_%i",gridPoint_z*15+gridPoint_x);
      sprintf(name,"(X,Z)=(%i cm,%i cm)",gridPoint_x*5+5,gridPoint_z*5+5);
      htrackInPads[gridPoint_z*15+gridPoint_x] =
	new TH2I(tit,name,
		 histoBins_x, gridPoint_x*500+250, gridPoint_x*500+750,
		 histoBins_z, gridPoint_z*500+250, gridPoint_z*500+750);// in [pad number]
  ...
  if(ppointsPerEvent_lan) delete[] ppoint_lan;
  ...
  if(FIT){
	...
	TF2 *f2 = new TF2(namef2,"xygaus",
			  gridPoint_x*500+350,gridPoint_x*500+650,
			  gridPoint_z*500+350,gridPoint_z*500+650);
  ...
  if(SHOW){
    ...
    c11->Divide(5,8);
    for(Int_t gridPoint_z=0; gridPoint_z<8;gridPoint_z++){ //8 points from 5 to 40 cm (200cm long TPC)
      for(Int_t gridPoint_x=0; gridPoint_x<5;gridPoint_x++){ //5 points from 5 to 25 cm (80cm wide TPC)
    ...
    c12->Divide(5,8);
    for(Int_t gridPoint_z=0; gridPoint_z<8;gridPoint_z++){ //8 points from 5 to 40 cm (200cm long TPC)
      for(Int_t gridPoint_x=5; gridPoint_x<10;gridPoint_x++){ //15 points from 30 to 50 cm (80cm wide TPC)
    ...
    c13->Divide(5,8);
    for(Int_t gridPoint_z=0; gridPoint_z<8;gridPoint_z++){ //8 points from 5 to 40 cm (200cm long TPC)
      for(Int_t gridPoint_x=10; gridPoint_x<15;gridPoint_x++){ //15 points from 55 to 75 cm (80cm wide TPC)
    ...
    c21->Divide(5,8);
    for(Int_t gridPoint_z=8; gridPoint_z<16;gridPoint_z++){ //8 points from 45 to 80 cm (200cm long TPC)
      for(Int_t gridPoint_x=0; gridPoint_x<5;gridPoint_x++){ //5 points from 5 to 25 cm (80cm wide TPC)
    ...
    c31->Divide(5,8);
    for(Int_t gridPoint_z=16; gridPoint_z<24;gridPoint_z++){ //8 points from 85 to 120 cm (200cm long TPC)
      for(Int_t gridPoint_x=0; gridPoint_x<5;gridPoint_x++){ //5 points from 5 to 25 cm (80cm wide TPC)
    ...
    c41->Divide(5,8);
    for(Int_t gridPoint_z=24; gridPoint_z<32;gridPoint_z++){ //8 points from 125 to 160 cm (200cm long TPC)
      for(Int_t gridPoint_x=0; gridPoint_x<5;gridPoint_x++){ //5 points from 5 to 25 cm (80cm wide TPC)
    ...
    c51->Divide(5,7);
    for(Int_t gridPoint_z=32; gridPoint_z<39;gridPoint_z++){ //8 points from 165 to 195 cm (200cm long TPC)
      for(Int_t gridPoint_x=0; gridPoint_x<5;gridPoint_x++){ //5 points from 5 to 25 cm (80cm wide TPC)
