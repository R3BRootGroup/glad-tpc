...
class R3BGTPCPoint : public FairMCPoint
{
 ...
 public:
   ...
   **/
  R3BGTPCPoint(Int_t trackID, Int_t detID, Int_t detCopyID,
...
inline void R3BGTPCPoint::SetPositionOut(TVector3 pos) {
  fX_out = pos.X();
  fY_out = pos.Y();
  fZ_out = pos.Z();
}

inline void R3BGTPCPoint::SetMomentumOut(TVector3 mom) {
  fPx_out = mom.Px();
  fPy_out = mom.Py();
  fPz_out = mom.Pz();
}
